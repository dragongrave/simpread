> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [gitbook.cn](https://gitbook.cn/gitchat/column/5ce4ff9a308dd66813d92799/topic/5ce527b6308dd66813d92a6b)
...
搜索最容易产生问题的地方在于深度搜索和深度翻页。在我们处理过的各种问题中，很多业务确实不了解深层聚合会给集群带来什么样的压力，曾经有一个业务的集群总是在某个特定的时间点有节点离线的情况，业务抱怨集群不稳定，经过检查后发现业务的聚合请求的 bucket 为 1000000 * 1000000，这就很容易造成节点 OOM，又或者业务进行 3 层或 4 层的深度聚合，一样会造成协调节点内存暴涨。
